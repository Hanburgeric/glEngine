...
void main() {
    ...
    vec3 Lo = vec3(0.0);
    {
        ...
        vec3 L = normalize(vec3(0.0f, 0.0f, 10.0f) - WorldPos);
        vec3 H = normalize(V + L);
        float distance = length(vec3(0.0f, 0.0f, 10.0f) - WorldPos);
        float attenuation = 1.0 / (distance * distance);
        vec3 radiance = vec3(150.0f, 150.0f, 150.0f) * attenuation; //Light Color
